        ...
        <div class="flex flex-col lg:flex-row">
            <div class="lg:w-1/2 bg-gray-200 p-14">
                <div class="container mx-auto">
                    <p class="text-4xl md:text-5xl font-extrabold text-orange-500">Disminuye la inversión de tiempo</p>
            ...
            <img class="lg:w-1/2" src="{{ asset('img/7.jpg') }}" alt="Imágen de tiempo">
        </div>
    </section>
    ...
    <section
        <div class="flex lg:flex-row flex-col-reverse">
            ...
            <div class="lg:w-1/2 bg-gray-200 p-14 justify-start">
                <div class="container mx-auto">
                    <p class="text-4xl md:text-5xl font-extrabold text-orange-500">Conoce nuestros servicios</p>
                    <ul class="mt-4">
